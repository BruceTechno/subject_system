...
//        CourseAddRequest codeIsNull = new CourseRequest("", "電子學", "星期二", 900, 950, 1, 0);
//        CourseAddResponse res = courseService.courseAdd(codeIsNull);
...
//        list.add("K");
//		list.add("C");
//        CourseSelectRequest courseRequest = new CourseRequest(10002, "陳聖和2", list);
